...
ActiveRecord::Schema[7.1].define(version: 2025_12_05_081553) do
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.string "provider"
    t.string "line_login_uid"
    t.string "name"
    t.string "line_messaging_user_id"
    t.string "line_nonce"
    t.index ["email"], name: "index_users_on_email", unique: true
    t.index ["line_messaging_user_id"], name: "index_users_on_line_messaging_user_id"
    t.index ["provider", "line_login_uid"], name: "index_users_on_provider_and_line_login_uid", unique: true
